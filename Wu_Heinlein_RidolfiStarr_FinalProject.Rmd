...
WQ_monthly_complete <- WQ_monthly_complete %>%
  mutate(
    ...
    Interp_NO2_NO3 = na.approx(Mean_NO2_NO3),
    Interp_Turbidity = na.approx(Mean_Turbidity),
    Interp_Salinity = na.approx(Mean_Salinity),
    Interp_Water_Temp = na.approx(Mean_Water_Temp),
    Interp_Kjeldahl_Nitrogen = na.approx(Mean_Kjeldahl_Nitrogen),
    Interp_Specific_Conduc = na.approx(Mean_Specific_Conduc),
...
#nitrates & nitrites
nitrates.nitrites.plot <- ggplot(WQ_monthly_complete) +
  geom_line(aes(x=Date, y=Interp_NO2_NO3), color="red") +
  geom_line(aes(x=Date, y=Mean_NO2_NO3)) +
  geom_smooth(aes(x=Date, y=Interp_NO2_NO3), method="lm") +
  geom_vline(xintercept = as.Date("2021-04-01"), lty = 2)
nitrates.nitrites.plot
...
#salinity
salinity.plot <- ggplot(WQ_monthly_complete) +
  geom_line(aes(x=Date, y=Interp_Salinity), color="red") +
  geom_line(aes(x=Date, y=Mean_Salinity)) +
  geom_smooth(aes(x=Date, y=Interp_Salinity), method="lm") +
  geom_vline(xintercept = as.Date("2021-04-01"), lty = 2)
salinity.plot
...
#phosphorous
P_pre_plot <- ggplot(pre_ordinance_data) +
  geom_line(aes(x=Date, y=Interp_Phosphorous), color="red") +
  geom_line(aes(x=Date, y=Mean_Phosphorous)) +
  geom_smooth(aes(x=Date, y=Interp_Phosphorous), method="lm")
P_pre_plot

P_post_plot <- ggplot(post_ordinance_data) +
  geom_line(aes(x=Date, y=Interp_Phosphorous), color="red") +
  geom_line(aes(x=Date, y=Mean_Phosphorous)) +
  geom_smooth(aes(x=Date, y=Interp_Phosphorous), method="lm") +
  geom_vline(xintercept = as.Date("2021-04-01"), lty = 2)
...
#nitrogen
N_pre_plot <- ggplot(pre_ordinance_data) +
  geom_line(aes(x=Date, y=Interp_Total_N), color="red") +
  geom_line(aes(x=Date, y=Mean_Total_N)) +
  geom_smooth(aes(x=Date, y=Interp_Total_N), method="lm")
N_pre_plot

N_post_plot <- ggplot(post_ordinance_data) +
  geom_line(aes(x=Date, y=Interp_Total_N), color="red") +
  geom_line(aes(x=Date, y=Mean_Total_N)) +
  geom_smooth(aes(x=Date, y=Interp_Total_N), method="lm") +
  geom_vline(xintercept = as.Date("2021-04-01"), lty = 2)
...
#nitrates & nitrites
NO2NO3_pre_plot <- ggplot(pre_ordinance_data) +
  geom_line(aes(x=Date, y=Interp_NO2_NO3), color="red") +
  geom_line(aes(x=Date, y=Mean_NO2_NO3)) +
  geom_smooth(aes(x=Date, y=Interp_NO2_NO3), method="lm")
NO2NO3_pre_plot

NO2NO3_post_plot <- ggplot(post_ordinance_data) +
  geom_line(aes(x=Date, y=Interp_NO2_NO3), color="red") +
  geom_line(aes(x=Date, y=Mean_NO2_NO3)) +
  geom_smooth(aes(x=Date, y=Interp_NO2_NO3), method="lm") +
  geom_vline(xintercept = as.Date("2021-04-01"), lty = 2)
...
#dissolved oxygen
O_pre_plot <- ggplot(pre_ordinance_data) +
  geom_line(aes(x=Date, y=Interp_Dissolved_O2), color="red") +
  geom_line(aes(x=Date, y=Mean_Dissolved_O2)) +
  geom_smooth(aes(x=Date, y=Interp_Dissolved_O2), method="lm")
O_pre_plot

O_post_plot <- ggplot(post_ordinance_data) +
geom_line(aes(x=Date, y=Interp_Dissolved_O2), color="red") +
  geom_line(aes(x=Date, y=Mean_Dissolved_O2)) +
  geom_smooth(aes(x=Date, y=Interp_Dissolved_O2), method="lm") +
  geom_vline(xintercept = as.Date("2021-04-01"), lty = 2)
...
#pH
pH_pre_plot <- ggplot(pre_ordinance_data) +
  geom_line(aes(x=Date, y=Interp_pH), color="red") +
  geom_line(aes(x=Date, y=Mean_pH)) +
  geom_smooth(aes(x=Date, y=Interp_pH), method="lm")
pH_pre_plot

pH_post_plot <- ggplot(post_ordinance_data) +
geom_line(aes(x=Date, y=Interp_pH), color="red") +
  geom_line(aes(x=Date, y=Mean_pH)) +
  geom_smooth(aes(x=Date, y=Interp_pH), method="lm") +
  geom_vline(xintercept = as.Date("2021-04-01"), lty = 2)
...
#salinity
Sal_pre_plot <- ggplot(pre_ordinance_data) +
  geom_line(aes(x=Date, y=Interp_Salinity), color="red") +
  geom_line(aes(x=Date, y=Mean_Salinity)) +
  geom_smooth(aes(x=Date, y=Interp_Salinity), method="lm")
Sal_pre_plot

Sal_post_plot <- ggplot(post_ordinance_data) +
  geom_line(aes(x=Date, y=Interp_Salinity), color="red") +
  geom_line(aes(x=Date, y=Mean_Salinity)) +
  geom_smooth(aes(x=Date, y=Interp_Salinity), method="lm") +
  geom_vline(xintercept = as.Date("2021-04-01"), lty = 2)
...
#yearly averages for time series
summer_readings_yearly <- WQ_parameters_raw %>%
...
#daily readings for ANOVA
summer_readings_daily <- WQ_parameters_raw %>%
