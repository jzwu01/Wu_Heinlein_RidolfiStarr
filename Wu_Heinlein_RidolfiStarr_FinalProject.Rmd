...
```
[say something here; maybe about outliers]
...
```{r previewplots, echo=FALSE, message=FALSE, warning=FALSE, fig.height=11, fig.cap="Monthly Averages of Water Quality Parameters"}
#Exploring series
