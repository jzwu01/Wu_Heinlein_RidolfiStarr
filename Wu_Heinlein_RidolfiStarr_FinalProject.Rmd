...
#P overall monthly trend analysis
...
#N overall monthly trend analysis
...
#O2 overall monthly trend analysis
...
#pH overall monthly trend analysis
...
prevspost.SMK.summary <- data.frame(
  "Pre-Ordinance_Stat" = pre.stat.summary,
  "Pre-Ordinance_p-value" = pre.pvalue.summary,
  "Post-Ordinance_Stat" = post.stat.summary,
